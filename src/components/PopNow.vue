<template>
  <section class="popnow">
      ...
      <div class="popnpw__tiny">
        <tiny-slider v-bind="options"	>
          <div
          ...
          > 
            ...
            <div class="popnow__wrapper"><img class="popnow__img popnow__img--prod" :class="card.imgClass" :src="card.prodimgSrc"></div>
